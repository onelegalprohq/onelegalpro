...
- **No production-readiness, certification, or compliance claim is made.** **15 September 2026 is a target, not a contractual commitment**, and production access requires the recorded evidence listed in `docs/architecture/02_Product_Requirements.md` §8 — including an approved database design, which `docs/architecture/03_Database_Design.md` does **not** yet contain.
