...
EPIC-001 — Platform Foundation (repository implementation track). EPIC-002 — Legal Intelligence, EPIC-003 — White-Label Platform, EPIC-004 — Communications Hub, EPIC-005 — Digital Presence Platform, and EPIC-006 — Practice Management Core are proposed at the architecture level only; see `docs/architecture/08_Roadmap.md`.
