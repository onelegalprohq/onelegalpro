...
Amendments to this Constitution require an approved ADR and explicit human sign-off, consistent with the approval gates in `AGENTS.md`. This requirement applies in full to Articles 22–25: no financial, client-money, or Financial AI rule may be weakened without an approved ADR and recorded human approval. It applies equally to Articles 26–30: no identity, authentication, authorization, Ethical Wall, privileged-access, or security-audit rule may be weakened without an approved ADR and recorded human approval.
