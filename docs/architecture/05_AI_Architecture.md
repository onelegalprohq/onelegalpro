...
The following extend the same governing principle — AI output is advisory only, never authoritative, always subject to human review — to AI and OCR capabilities over documents, per `docs/architecture/14_Document_Management_Architecture.md` and `docs/architecture/01_OneLegalPro_Constitution.md`, Articles 18–19. They do not modify the Legal Intelligence, Communications Hub, or Practice Management AI rules above.
